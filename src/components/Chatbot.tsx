...
export default function Chatbot() {
  ...
  return (
    <>
      ...
      >
        {isOpen ? <X size={24} className="text-white" /> :  <Image src="/assets/chat/chat_icon.png" alt="Chatbot" width={100} height={100} />}
        ...
        <div className="fixed bottom-24 right-6 w-[400px] h-[700px] glass-card shadow-2xl z-40 flex flex-col overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-primary-500 to-accent-500 p-4 flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
              <Image src="/assets/chat/chat_icon.png" alt="Chatbot" width={40} height={40} />
            </div>
            <div>
              <h3 className="text-white font-semibold">AI Assistant</h3>
              <p className="text-primary-100 text-sm">Ask me about Shailesh</p>
            </div>
          </div>
